                    ...
                    <div class="js-sticky-block card bg-white"
                        ...
                        <div class="card-header text-center py-5 ">
                            <div class="max-w-27rem mx-auto mb-3">
                                @if (!empty($profile->logo) && file_exists('storage/logo/' . $profile->logo))
                                    <img class="avatar-img-custom" src="{{ asset('storage/logo/' . $profile->logo) }}"
                        ...
                        <div class="card-body text-center">
                            <div class="border-bottom pb-2 mb-3">
                                <div class="row">
                                    @auth
                                        <div class="col-6 col-md-6 col-lg-6 mb-0">
                                            <!-- Icon Block -->
                                        ...
                                        @if (Auth::user()->hasRole('employer'))
                                            <a class="col-6 col-md-6 col-lg-6 mb-4"
                            ...
                            @auth
                                @if (Auth::user()->hasRole('employer') && Auth::user()->username == $account->username)
                                    <div class="mb-0">
                                            ...
                                            <div class="card-body ">
                                                <div class="row">
                                                    <div class="col-sm-3 col-lg-3 mb-3 mb-sm-0">
                                                        @if (!empty($profile->logo) && file_exists('storage/logo/' . $profile->logo))
                                                            <img class="mb-1 avatar-img-custom"
