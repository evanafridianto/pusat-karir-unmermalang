...
@section('content')
    <main id="content" role="main">
        ...
        <div class="position-relative border-bottom">
            ...
            <div id="heroNav" class="js-slick-carousel slick slick-equal-height"
                ...
                @foreach ($carousels as $carousel)
                    <div class="js-slide gradient-y-overlay-sm-dark bg-img-hero"
                        style="background-image: url({{ !empty($carousel->image) && file_exists('storage/page/' . $carousel->image) ? asset('storage/page/' . $carousel->image) : '' }});">
                        <!-- Slide #2 -->
                        <div
                            ...
                            <div class="w-80 w-lg-50">
                                ...
                                <span class="d-block h3 text-white mb-2" data-hs-slick-carousel-animation="fadeInUp">
                                    <a href="{{ route($carousel->slug) }}" class="btn btn-outline-indigo">Selengkapnya</a>
                                </span>
                            </div>
                        </div>
                        <!-- End Slide #2 -->
            ...
            <h3 class="text-center display-4 mt-8 mb-0">Cari <span class="text-custom">pekerjaan yang cocok</span>
                untukmu disini!</h3>
